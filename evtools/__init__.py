...
#   
#  This file is part of the evTools Python package:
#  Analyse and display output from the binary stellar-evolution code ev (a.k.a. STARS or TWIN).
#  See: https://github.com/MarcvdSluys/evTools-python
#   
...
Netherlands.  The evTools package can be used under the conditions of the EUPL 1.2 licence.  These pages
contain the API documentation.  For more information on the Python package, licence and source code, see the
`evTools GitHub page <https://github.com/MarcvdSluys/evTools-python>`_.
"""
